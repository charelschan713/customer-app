...
export default function AppLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="bookings" options={{ title: 'Trips',    tabBarIcon: ({ color, size }) => <Ionicons name="car-outline"           size={size} color={color} /> }} />
      <Tabs.Screen name="payments" options={{ title: 'Wallet',   tabBarIcon: ({ color, size }) => <Ionicons name="card-outline"         size={size} color={color} /> }} />
